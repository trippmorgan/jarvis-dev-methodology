"""User store module — complete version with search functionality."""


class UserStore:
    """In-memory user storage with CRUD and search operations."""
    ...
    def search_by_name(self, query):
        ...
        Args:
            query: The search string to match against user names.
                   An empty string matches all users.

        Returns:
            A list of user dicts whose names contain the query substring.
        """
        if not query:
